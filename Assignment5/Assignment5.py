...
govern_measures_data_file = "acaps_covid19_government_measures_dataset_0.xlsx"

govern_restrictions_data_file = "Dataset1.csv"

# Source : https://raw.githubusercontent.com/OxCGRT/covid-policy-tracker/master/data/OxCGRT_latest.csv
owid_covid_data_file = "owid-covid-data.csv"

recoveries_data_file = "time_series_covid19_recovered_global.csv"
